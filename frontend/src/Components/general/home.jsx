...
import PitchforkArticles from './articles.jsx'; 
...
function Home() {
    ...
    // Function to shuffle genres on the home page on every refresh or redirect  
    ...
    // Function for handling spotify authentication/account linkage redirect
    ...
    useEffect(() => {
        ...
        // Function for collecting information such as articles, users, genres, new releases, tokens
    ...
    // Fetches access token for spotify API
    ...
    // Searches for specific endpoint at the Spotify API with a valid token
