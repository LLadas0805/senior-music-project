...
function AlbumPage() {
    ...
    // Function to darken a specific color
    ...
    useEffect(() => {
        ...
        // Function that fetches token, search endpoints, reviews and sets all the states
    ...
    // Function to format album duration
    ...
    // Function to fetch access token for use in the Spotify API
    ...
    // Searches for information at a given Spotify API endpoint with a valid token and route
